...
const DisplayBook = ({ user }) => {
    const { Image, Name, authorName, Category,Rating,_id,Quantity } = user || {};
            ...
            <div className="hero  bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <Link to={`/updateBook/${_id}`}><button className="btn bg-green-600 hover:bg-green-700">Update Details</button></Link>
